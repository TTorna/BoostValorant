...
const ranks = [
  ...
  { id: 8, name: 'Bronze', tiers: ['I', 'II', 'III'], color: 'from-amber-600 to-amber-800' },
  { id: 11, name: 'Silver', tiers: ['I', 'II', 'III'], color: 'from-gray-300 to-gray-400' },
  { id: 14, name: 'Gold', tiers: ['I', 'II', 'III'], color: 'from-yellow-400 to-yellow-600' },
  { id: 17, name: 'Platinum', tiers: ['I', 'II', 'III'], color: 'from-cyan-400 to-cyan-600' },
  { id: 20, name: 'Diamond', tiers: ['I', 'II', 'III'], color: 'from-purple-400 to-purple-600' },
  { id: 23, name: 'Ascendant', tiers: ['I', 'II', 'III'], color: 'from-green-400 to-green-600' },
  { id: 26, name: 'Immortal', tiers: ['I', 'II', 'III'], color: 'from-red-400 to-red-600' },
  { id: 27, name: 'Radiant', tiers: ['I'], color: 'from-yellow-200 to-yellow-400' },
];
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative group">
          ...
          <div className="w-36 h-36 relative transition-transform duration-300 transform group-hover:scale-110">
            <img
              src={`https://trackercdn.com/cdn/tracker.gg/valorant/icons/tiersv2/${ranks[selectedRank].id}.png`}
